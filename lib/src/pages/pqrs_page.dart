...
import '../api/pqrs_api_service.dart';
      ...
      try {
        ...
        if (result['success']) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(
                '¡$_selectedType enviada con éxito! La administración atenderá su caso pronto.',
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(
                result['message'] ?? 'Error al enviar la $_selectedType',
                style: GoogleFonts.outfit(),
              ),
              behavior: SnackBarBehavior.floating,
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Selecciona el tipo de solicitud y detalla los motivos para que nuestra administración pueda atender y resolver tu caso.',
                style: GoogleFonts.outfit(
                  fontSize: 14,
              ...
              Container(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton<String>(
                    ...
                    items: _pqrsTypes.map((String type) {
              ...
              TextFormField(
                ...
                validator: (value) {
                  ...
                  if (value.trim().length < 10) {
                    return 'El detalle debe ser más descriptivo (mín. 10 caracteres).';
                  }
                  return null;
                },
              ),
              ...
              TextFormField(
                ...
                validator: (value) {
                  if (value == null || value.trim().isEmpty) {
                    return 'Por favor, proporciona un medio de contacto.';
                  }
                  return null;
                },
              ),
