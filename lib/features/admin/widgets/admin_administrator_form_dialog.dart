...
class AdminAdministratorFormDialog extends StatefulWidget {
  ...
  @override
  State<AdminAdministratorFormDialog> createState() => _AdminAdministratorFormDialogState();
}

class _AdminAdministratorFormDialogState extends State<AdminAdministratorFormDialog> {
  ...
  void initState() {
    ...
    if (admin != null) {
      firstName = admin['prim_nombre'] ?? '';
      secondName = admin['seg_nombre'] ?? '';
      lastName1 = admin['apellido1'] ?? '';
      lastName2 = admin['apellido2'] ?? '';
    }
    ...
    _phoneController = TextEditingController(text: admin?['telefono'] ?? '');
  ...
  Widget build(BuildContext context) {
    ...
    final isEdit = widget.administrator != null;
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildTextField(
                        ...
                        hint: isEdit ? 'Dejar en blanco para no cambiar' : 'Mínimo 8 caracteres',
                        isDark: isDark,
